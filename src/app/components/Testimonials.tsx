  ...
  return (
    <section className="py-24 relative overflow-hidden" style={{ background: colors.bg, transition: "background-color 0.4s ease" }}>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(212,255,0,0.04), transparent)", filter: "blur(60px)" }} />
        ...
        <div className="relative">
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-10 items-start">
                <div className="flex-shrink-0">
                  <div className="w-20 h-20 rounded-2xl overflow-hidden"
                    style={{ border: "2px solid rgba(212,255,0,0.3)", boxShadow: "0 0 20px rgba(212,255,0,0.15)" }}>
                    <ImageWithFallback
                      src={avatars[current]}
                ...
                <div className="flex-1">
                  <div className="flex gap-1 mb-4">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} size={16} fill="#d4ff00" style={{ color: "#d4ff00" }} />
                    ))}
                  </div>

                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-5"
                    style={{ background: "rgba(212,255,0,0.1)", border: "1px solid rgba(212,255,0,0.25)" }}>
                    <span style={{ color: "#d4ff00", fontSize: "0.7rem" }}>★</span>
                    <span style={{ fontFamily: "'Space Grotesk', sans-serif", color: "#d4ff00", fontSize: "0.75rem", fontWeight: 600 }}>
              ...
              <div className="absolute top-8 right-10 pointer-events-none select-none"
                style={{ fontFamily: "serif", fontSize: "8rem", color: "rgba(212,255,0,0.06)", lineHeight: 1, fontWeight: 900 }}>
                "
              </div>
            </motion.div>
          </AnimatePresence>
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <motion.button onClick={() => go(-1)} className="w-12 h-12 rounded-full flex items-center justify-center"
              ...
              whileHover={{ scale: 1.1, borderColor: "rgba(212,255,0,0.4)", color: "#d4ff00" }}
              whileTap={{ scale: 0.95 }}>
              <ChevronLeft size={20} />
            </motion.button>
              ...
              {t.items.map((_, i) => (
                <motion.button
                  ...
                  style={{
                    ...
                    height: "8px",
                    background: i === current ? "#d4ff00" : colors.textDim,
                    boxShadow: i === current ? "0 0 10px #d4ff00" : "none",
                    border: "none",
                    cursor: "pointer",
                    transition: "all 0.3s",
                  }}
