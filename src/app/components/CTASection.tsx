  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden" style={{ background: colors.bg, transition: "background-color 0.4s ease" }}>
      <div className="absolute top-0 left-0 right-0 h-px"
        style={{ background: "linear-gradient(90deg, transparent, rgba(212,255,0,0.3), transparent)" }} />
      ...
      <div className="max-w-5xl mx-auto px-6">
        <motion.div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(212,255,0,0.08) 0%, rgba(0,255,136,0.04) 50%, rgba(212,255,0,0.06) 100%)",
        ...
        >
          <motion.div
            ...
            animate={{
              background: [
                "radial-gradient(ellipse at 20% 50%, rgba(212,255,0,0.08) 0%, transparent 60%)",
                "radial-gradient(ellipse at 80% 50%, rgba(212,255,0,0.08) 0%, transparent 60%)",
                "radial-gradient(ellipse at 20% 50%, rgba(212,255,0,0.08) 0%, transparent 60%)",
              ],
            }}
          ...
          <div className="absolute top-0 left-0 w-32 h-32 pointer-events-none opacity-40"
            style={{ background: "radial-gradient(circle at top left, rgba(212,255,0,0.2), transparent)" }} />
          <div className="absolute bottom-0 right-0 w-40 h-40 pointer-events-none opacity-40"
            style={{ background: "radial-gradient(circle at bottom right, rgba(0,255,136,0.15), transparent)" }} />
          ...
          <div className="relative z-10">
            <motion.div
              ...
              style={{ background: "rgba(212,255,0,0.1)", border: "1px solid rgba(212,255,0,0.3)" }}
            >
            ...
            >
              {t.titleMain}{" "}
              <span style={{ color: "#d4ff00", textShadow: "0 0 40px rgba(212,255,0,0.5)" }}>{t.titleAccent}</span>
              {" "}{t.titleEnd}
            </motion.h2>
            ...
            >
              <motion.button
                ...
                style={{
                  ...
                  border: "none",
                  cursor: "pointer",
                  boxShadow: "0 0 40px rgba(212,255,0,0.4)",
                }}
                whileHover={{ scale: 1.05, boxShadow: "0 0 60px rgba(212,255,0,0.6)" }}
                whileTap={{ scale: 0.97 }}
              >
                {t.btn1}
                <ArrowRight size={18} />
              ...
              <motion.button
                ...
                whileHover={{ background: colors.cardHover, borderColor: "rgba(212,255,0,0.4)", scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
              >
                {t.btn2}
              </motion.button>
