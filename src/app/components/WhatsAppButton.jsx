...
export function WhatsAppButton() {
  ...
  return (
    <div
      className={`fixed bottom-6 z-50 flex flex-col items-end gap-3 ${isAr ? "left-6" : "right-6"}`}
    >
      {/* Tooltip */}
      <AnimatePresence>
        {showTooltip && (
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.12, boxShadow: "0 6px 30px rgba(37,211,102,0.6)" }}
        whileTap={{ scale: 0.95 }}
