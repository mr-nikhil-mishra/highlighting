  ...
  return (
    ...
    >
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-80 h-80 rounded-full pointer-events-none opacity-10"
        style={{ background: "radial-gradient(circle, var(--brand-sec), transparent)", filter: "blur(80px)" }} />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden" style={{ aspectRatio: "4/3" }}>
              ...
              <div className="absolute inset-0"
                style={{ background: "linear-gradient(135deg, rgba(var(--brand-neon-rgb),0.08) 0%, transparent 50%, rgba(0,0,0,0.3) 100%)" }} />
              <div className="absolute inset-0 rounded-3xl" style={{ border: "1px solid rgba(var(--brand-neon-rgb),0.15)" }} />
            </div>
            ...
            <motion.div
              ...
              style={{ background: colors.mobileMenu, border: "1px solid rgba(var(--brand-neon-rgb),0.3)", backdropFilter: "blur(20px)", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}
            >
              <div className="text-center">
                <p style={{ fontFamily: "'Space Grotesk', sans-serif", color: "var(--brand-neon)", fontSize: "2.5rem", fontWeight: 700, lineHeight: 1 }}>10+</p>
            ...
            <motion.div
              ...
              style={{ background: colors.mobileMenu, border: "1px solid rgba(var(--brand-sec-rgb),0.3)", backdropFilter: "blur(20px)", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "rgba(var(--brand-sec-rgb),0.12)" }}>
                  <span style={{ fontSize: "1.2rem" }}>🎯</span>
                </div>
                <div>
                  <p style={{ fontFamily: "'Space Grotesk', sans-serif", color: "var(--brand-sec)", fontSize: "1rem", fontWeight: 700 }}>{t.partnerLabel}</p>
          ...
          >
            ...
            <h2 className="mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 700, color: colors.text, letterSpacing: "-0.03em", lineHeight: 1.2, transition: "color 0.3s ease" }}>
              {t.title}{" "}
              <span className="relative inline-block" style={{ color: "var(--brand-neon)" }}>
                {t.titleAccent}
                <motion.span
                  className="absolute bottom-0 left-0 h-0.5 w-full"
                  style={{ background: "linear-gradient(90deg, var(--brand-neon), transparent)", boxShadow: "0 0 10px var(--brand-neon)" }}
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05, boxShadow: "0 0 50px rgba(var(--brand-neon-rgb),0.5)" }}
              whileTap={{ scale: 0.97 }}
            >
              {t.cta}
            </motion.button>
