...
function Card({ reason, index, colors }: {
  reason: { number: string; title: string; desc: string };
  index: number;
  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-3xl"
        style={{ background: "linear-gradient(135deg, rgba(212,255,0,0.06), rgba(0,255,136,0.03))" }} />
      <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
        style={{ border: "1px solid rgba(212,255,0,0.35)", boxShadow: "inset 0 0 30px rgba(212,255,0,0.05)" }} />
      ...
      <div className="mb-6 relative z-10">
        <span
          style={{
            ...
            fontWeight: 700,
            color: "transparent",
            WebkitTextStroke: "1px rgba(212,255,0,0.25)",
            lineHeight: 1,
          }}
        >
          {reason.number}
      ...
      <div className="absolute -bottom-8 -right-8 w-32 h-32 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(212,255,0,0.12), transparent)" }} />
    </motion.div>
  );
}
