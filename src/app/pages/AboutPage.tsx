...
const teamColors = ["#d4ff00", "#00ff88", "#d4ff00", "#00ff88"];
        ...
        <div className="max-w-5xl mx-auto px-6 mt-16">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {stats.map((stat, i) => (
              ...
              >
                <p style={{ fontFamily: "'Space Grotesk', sans-serif", color: "#d4ff00", fontSize: "2rem", fontWeight: 700, textShadow: "0 0 20px rgba(212,255,0,0.4)" }}>
                  {stat.value}
                </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden" style={{ aspectRatio: "4/3" }}>
                ...
                <div className="absolute inset-0"
                  style={{ background: "linear-gradient(135deg, rgba(212,255,0,0.06) 0%, transparent 50%)", border: "1px solid rgba(212,255,0,0.12)", borderRadius: "1.5rem" }} />
              </div>
              ...
              <motion.div
                ...
                style={{ background: colors.mobileMenu, border: "1px solid rgba(212,255,0,0.3)", backdropFilter: "blur(20px)", boxShadow: "0 20px 50px rgba(0,0,0,0.2)" }}
              >
                <p style={{ fontFamily: "'Space Grotesk', sans-serif", color: "#d4ff00", fontSize: "1.8rem", fontWeight: 700 }}>2015</p>
            ...
            >
              ...
              <h2 className="mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 700, color: colors.text, letterSpacing: "-0.03em", lineHeight: 1.2, transition: "color 0.3s ease" }}>
                {t.storyTitle}{" "}
                <span style={{ color: "#d4ff00" }}>{t.storyAccent}</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: colors.text, letterSpacing: "-0.03em", transition: "color 0.3s ease" }}>
              {t.valuesTitle}{" "}
              <span style={{ color: "#d4ff00", textShadow: "0 0 30px rgba(212,255,0,0.4)" }}>{t.valuesAccent}</span>
            </h2>
          </motion.div>
            ...
            {t.values.map((val, i) => (
              ...
              >
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-3xl"
                  style={{ background: "linear-gradient(135deg, rgba(212,255,0,0.06), transparent)" }} />

                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5 text-2xl"
                  style={{ background: "rgba(212,255,0,0.08)", border: "1px solid rgba(212,255,0,0.2)" }}>
                  {val.icon}
                </div>
      ...
      <section className="py-24 relative" style={{ background: colors.bgAlt, transition: "background-color 0.4s ease" }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: colors.text, letterSpacing: "-0.03em", transition: "color 0.3s ease" }}>
              {t.teamTitle}{" "}
              <span style={{ color: "#d4ff00", textShadow: "0 0 30px rgba(212,255,0,0.4)" }}>{t.teamAccent}</span>
            </h2>
          </motion.div>
      ...
      <section className="py-24 relative" style={{ background: colors.bg, transition: "background-color 0.4s ease" }}>
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: colors.text, letterSpacing: "-0.03em", transition: "color 0.3s ease" }}>
              {t.awardsTitle}{" "}
              <span style={{ color: "#d4ff00", textShadow: "0 0 30px rgba(212,255,0,0.4)" }}>{t.awardsAccent}</span>
            </h2>
          </motion.div>
          ...
          <div className="flex flex-col gap-3">
            {t.awards.map((award, i) => (
              <motion.div
                ...
                style={{ background: colors.card, border: `1px solid ${colors.border}` }}
                whileHover={{ borderColor: "rgba(212,255,0,0.3)", x: 4 }}
              >
                <Award size={20} style={{ color: "#d4ff00", flexShrink: 0 }} />
