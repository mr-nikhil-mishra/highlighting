          ...
          <div className="grid lg:grid-cols-5 gap-10">
                  ...
                  {submitted ? (
                    ...
                    >
                      <motion.div
                        ...
                        style={{ background: "rgba(212,255,0,0.15)", border: "2px solid rgba(212,255,0,0.4)" }}
                      >
                        <CheckCircle2 size={36} style={{ color: "#d4ff00" }} />
                      </motion.div>
                    ...
                    >
                      <div className="grid sm:grid-cols-2 gap-5">
                        <div>
                          ...
                          <input
                            ...
                            style={inputStyle}
                            onFocus={(e) => { e.target.style.borderColor = "rgba(212,255,0,0.5)"; e.target.style.boxShadow = "0 0 15px rgba(212,255,0,0.1)"; }}
                      ...
                      <motion.button
                        ...
                        whileHover={{ scale: 1.02, boxShadow: "0 0 50px rgba(212,255,0,0.5)" }}
                        whileTap={{ scale: 0.98 }}
                      >
                        {t.submitBtn}
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex items-start gap-3">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(212,255,0,0.08)" }}>
                      <MapPin size={16} style={{ color: "#d4ff00" }} />
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(212,255,0,0.08)" }}>
                      <Phone size={16} style={{ color: "#d4ff00" }} />
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(212,255,0,0.08)" }}>
                      <Mail size={16} style={{ color: "#d4ff00" }} />
                    </div>
                    <p style={{ fontFamily: "'Inter', sans-serif", color: colors.textMuted, fontSize: "0.875rem", transition: "color 0.3s ease" }}>
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, rgba(212,255,0,0.1) 0%, rgba(0,255,136,0.05) 100%)",
                  border: "1px solid rgba(212,255,0,0.25)",
                }}
              >
                <motion.div
                  className="absolute inset-0 pointer-events-none"
                  animate={{ background: ["radial-gradient(circle at 20% 50%, rgba(212,255,0,0.08), transparent)", "radial-gradient(circle at 80% 50%, rgba(212,255,0,0.08), transparent)", "radial-gradient(circle at 20% 50%, rgba(212,255,0,0.08), transparent)"] }}
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-4"
                    ...
                    <Calendar size={20} style={{ color: "#d4ff00" }} />
                  </div>
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.03, boxShadow: "0 0 30px rgba(212,255,0,0.5)" }}
                    whileTap={{ scale: 0.97 }}
                  >
                    {t.bookBtn}
                  </motion.button>
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl"
                style={{ background: colors.card, border: `1px solid ${colors.border}` }}>
                <div className="w-3 h-3 rounded-full animate-pulse" style={{ background: "#00ff88", boxShadow: "0 0 10px #00ff88", flexShrink: 0 }} />
                <p style={{ fontFamily: "'Space Grotesk', sans-serif", color: colors.textMuted, fontSize: "0.85rem", transition: "color 0.3s ease" }}>
                  We typically respond within <span style={{ color: "#00ff88", fontWeight: 600 }}>2 hours</span> during business hours.
                </p>
              </div>
            </motion.div>
          </div>
