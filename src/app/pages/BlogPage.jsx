...
const categoryColors = {
  Strategy: "var(--brand-neon)",
  Performance: "var(--brand-sec)",
  "Social Media": "var(--brand-neon)",
  SEO: "var(--brand-sec)",
  "Web Design": "var(--brand-neon)",
  Video: "var(--brand-sec)",
  "Ø§Ù„Ø§Ø³ØªØ±Ø§ØªÙŠØ¬ÙŠØ©": "var(--brand-neon)",
  "Ø§Ù„Ø£Ø¯Ø§Ø¡": "var(--brand-sec)",
  "ÙˆØ³Ø§Ø¦Ù„ Ø§Ù„ØªÙˆØ§ØµÙ„": "var(--brand-neon)",
  "ØªØ­Ø³ÙŠÙ† Ù…Ø­Ø±ÙƒØ§Øª Ø§Ù„Ø¨Ø­Ø«": "var(--brand-sec)",
  "ØªØµÙ…ÙŠÙ… Ø§Ù„ÙˆÙŠØ¨": "var(--brand-neon)",
  "Ø§Ù„ÙÙŠØ¯ÙŠÙˆ": "var(--brand-sec)",
};
...
function BlogCard({ post, image, index, colors }) {
  ...
  const color = categoryColors[post.category] || "var(--brand-neon)";
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs"
              style={{ background: "rgba(var(--brand-neon-rgb),0.1)", border: "1px solid rgba(var(--brand-neon-rgb),0.2)" }}>
              ðŸ‘¤
            </div>
            <div>
            ...
            {t.categories.map((cat, i) => (
              <motion.button
                ...
                style={{
                  ...
                  fontWeight: 500,
                  cursor: "pointer",
                  background: activeCategory === i ? "linear-gradient(135deg, var(--brand-neon), var(--brand-dark))" : colors.card,
                  color: activeCategory === i ? "#050505" : colors.textMuted,
                  border: `1px solid ${activeCategory === i ? "transparent" : colors.border}`,
                  boxShadow: activeCategory === i ? "0 0 20px rgba(var(--brand-neon-rgb),0.3)" : "none",
                  transition: "all 0.3s",
                }}
