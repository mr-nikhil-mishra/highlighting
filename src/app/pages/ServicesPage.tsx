    ...
    >
      ...
      {index < 3 && (
        <div
          ...
          style={{ background: `linear-gradient(90deg, rgba(212,255,0,0.3), transparent)` }}
        />
      )}
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  color: "#d4ff00",
                  textShadow: isDark ? "0 0 40px rgba(212,255,0,0.5)" : "none",
                }}
              >
                {t.heroAccent}
              </span>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            >
              {t.processTitle}{" "}
              <span style={{ color: "#d4ff00", textShadow: "0 0 30px rgba(212,255,0,0.4)" }}>
                {t.processAccent}
              </span>
            </h2>
            <p
